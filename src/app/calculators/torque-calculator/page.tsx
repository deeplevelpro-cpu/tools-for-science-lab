import { TorqueCalculator } from "@/components/calculators/torque-calculator";
...
const pageTitle = "Torque Calculator | τ = Fr Formula, Force & Lever Arm";

const pageDescription =
  "Calculate torque, force, or lever arm distance using the τ = Fr physics formula. Solve rotational mechanics problems with SI units, examples, and step-by-step results.";
